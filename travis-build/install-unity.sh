...
UNITY_DOWNLOAD_CACHE="$(pwd)/$DOWNLOAD_CACHE"
UNITY_OSX_PACKAGE_URL="https://download.unity3d.com/download_unity/8a9509a5aff9/MacEditorInstaller/Unity-2018.4.3f1.pkg"
